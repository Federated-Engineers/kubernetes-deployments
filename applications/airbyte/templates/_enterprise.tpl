...
- name: AIRBYTE_AUTH_IDENTITY_PROVIDER_TYPE
  valueFrom:
    configMapKeyRef:
      name: {{ .Release.Name }}-airbyte-env
      key: AIRBYTE_AUTH_IDENTITY_PROVIDER_TYPE
- name: AIRBYTE_AUTH_IDENTITY_PROVIDER_OIDC_DOMAIN
  valueFrom:
    configMapKeyRef:
      name: {{ .Release.Name }}-airbyte-env
      key: AIRBYTE_AUTH_IDENTITY_PROVIDER_OIDC_DOMAIN
- name: AIRBYTE_AUTH_IDENTITY_PROVIDER_OIDC_APP_NAME
  valueFrom:
    configMapKeyRef:
      name: {{ .Release.Name }}-airbyte-env
      key: AIRBYTE_AUTH_IDENTITY_PROVIDER_OIDC_APP_NAME
...
- name: AB_AIRBYTE_AUTH_IDENTITY_PROVIDER_OIDC_ISSUER
  valueFrom:
    configMapKeyRef:
      name: {{ .Release.Name }}-airbyte-env
      key: AB_AIRBYTE_AUTH_IDENTITY_PROVIDER_OIDC_ISSUER
- name: AIRBYTE_AUTH_IDENTITY_PROVIDER_OIDC_CLIENT_ID
  valueFrom:
    secretKeyRef:
      name: {{ coalesce .Values.global.auth.identityProvider.oidc.clientIdSecretName .Values.global.auth.identityProvider.secretName (printf "%s-airbyte-secrets" .Release.Name) }}
      key: {{ .Values.global.auth.identityProvider.oidc.clientIdSecretKey }}
- name: AIRBYTE_AUTH_IDENTITY_PROVIDER_OIDC_CLIENT_SECRET
  valueFrom:
    secretKeyRef:
      name: {{ coalesce .Values.global.auth.identityProvider.oidc.clientSecretSecretName .Values.global.auth.identityProvider.secretName (printf "%s-airbyte-secrets" .Release.Name) }}
      key: {{ .Values.global.auth.identityProvider.oidc.clientSecretSecretKey }}
- name: AB_AIRBYTE_AUTH_IDENTITY_PROVIDER_OIDC_AUDIENCE
  valueFrom:
    secretKeyRef:
      name: {{ coalesce .Values.global.auth.identityProvider.oidc.clientIdSecretName .Values.global.auth.identityProvider.secretName (printf "%s-airbyte-secrets" .Release.Name) }}
      key: {{ .Values.global.auth.identityProvider.oidc.clientIdSecretKey }}
- name: AB_AIRBYTE_AUTH_IDENTITY_PROVIDER_AUDIENCE
  valueFrom:
    secretKeyRef:
      name: {{ coalesce .Values.global.auth.identityProvider.oidc.clientIdSecretName .Values.global.auth.identityProvider.secretName (printf "%s-airbyte-secrets" .Release.Name) }}
      key: {{ .Values.global.auth.identityProvider.oidc.clientIdSecretKey }}
